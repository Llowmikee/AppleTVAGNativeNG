(function () {
  ...
  const ru = {
    ...
    set_about_desc: 'Версия 0.3.17  Авторы: llowmikee, nrsua, gwynnbleiidd, arabianq, ang3el7z',
  ...
  const en = {
    ...
    set_about_desc: 'Version 0.3.17  Authors: llowmikee, nrsua, gwynnbleiidd, arabianq, ang3el7z',
  ...
  const uk = {
    ...
    set_about_desc: 'Версія 0.3.17  Автори: llowmikee, nrsua, gwynnbleiidd, arabianq, ang3el7z',
