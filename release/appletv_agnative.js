(function () {
  ...
  const en = {
    ...
    set_about_desc: `Version ${VERSION}  Authors: llowmikee, nrsua, gwynnbleiidd, arabianq, ang3el7z`,
  ...
  const be = {
    ...
    set_about_desc: `Версія ${VERSION} Аўтары: llowmikee, nrsua, gwynnbleiidd, arabianq, ang3el7z`,
    ...
    set_logo_title_name: 'Назва на лакальнай мове',
    set_logo_title_desc: 'Паказваць назву на лакальнай мове, калі лагатып загружаны толькі па-англійску',
    val_logo_title_off: 'Не',
    val_logo_title_below: 'Так, знізу лагатыпа',
    val_logo_title_above: 'Так, зверху лагатыпа'
  };
