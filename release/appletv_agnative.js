(function () {
  ...
  const uk = {
    ...
    set_about_desc: 'Версія 0.3.15  Автори: llowmikee, nrsua, gwynnbleiidd, arabianq, ang3el7z, dimir96',
  ...
  const be = {
    ...
    set_about_desc: 'Версія 0.3.14 Аўтары: llowmikee, nrsua, gwynnbleiidd, arabianq, ang3el7z, dimir96',
